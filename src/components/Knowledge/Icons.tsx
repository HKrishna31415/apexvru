...
export const Atom: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="1"/><path d="M20.2 20.2c2.04-2.03.02-5.91-2.81-8.74-2.83-2.83-6.7-4.85-8.74-2.81-2.03 2.04-.02 5.91 2.81 8.74 2.83 2.83 6.7 4.85 8.74 2.81Z"/><path d="M3.8 3.8c-2.04 2.03-.02 5.91 2.81 8.74 2.83 2.83 6.7 4.85 8.74 2.81 2.03-2.04.02-5.91-2.81-8.74-2.83-2.83-6.7-4.85-8.74-2.81Z"/></svg>
);
...
export const Factory: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M2 22h20"/><path d="M17 22V10l-5 4-5-4v12"/><path d="M12 10V4h5v6Z"/></svg>
);

export const Leaf: React.FC<IconProps> = ({ className }) => (
  <FaLeaf className={className} size={24} color="black" />
);

export const HandCoins: React.FC<IconProps> = ({ className }) => (
  <FaHandHoldingUsd className={className} size={24} color="black" />
);
...
export const Loader: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 2v4"/><path d="m4.93 4.93 2.83 2.83"/><path d="M2 12h4"/><path d="m4.93 19.07 2.83-2.83"/><path d="M12 18v4"/><path d="m19.07 19.07-2.83-2.83"/><path d="M22 12h-4"/><path d="m19.07 4.93-2.83 2.83"/></svg>
);

export const Sparkles: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m12 3-1.9 4.2-4.3.6 3.1 3-1 4.2 3.8-2.3 3.8 2.3-1-4.2 3.1-3-4.3-.6Z"/><path d="M3 12.5 5 12l.5-2.5L7.5 12 10 12.5 7.5 13l-2 2.5Z"/><path d="m14 6-.5-2-2-2.5 2.5.5L18.5 4 16 6.5Z"/></svg>
);
